...
/**
 * Dados do Evento para o Evento de Carga Manipulada
 */
public class CargoHandledEventData {
    ...
    public CargoHandledEventData(String bookingId, String handlingType, Date handlingCompletionTime,
    ...
    public Date getHandlingCompletionTime() {
        return this.handlingCompletionTime;
    }

    public String getHandlingLocation() {
        return this.handlingLocation;
    }

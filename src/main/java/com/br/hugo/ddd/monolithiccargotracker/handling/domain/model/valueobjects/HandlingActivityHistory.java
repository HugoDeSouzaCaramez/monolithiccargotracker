...
public class HandlingActivityHistory {
    ...
    /**
     * @return Uma lista distinta (sem registros duplicados) de eventos de manuseio,
     *         ordenada pelo tempo de conclusão.
     */
    ...
    /**
     * @return O evento concluído mais recentemente, ou null se o histórico de
     *         entrega
     *         estiver vazio.
     */

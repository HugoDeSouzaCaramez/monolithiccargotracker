package com.br.hugo.ddd.monolithiccargotracker.handling.interfaces.rest.dto;
...
public class HandlingActivityRegistrationResource {
    ...
    public HandlingActivityRegistrationResource(String bookingId, String voyageNumber, String unLocode,
            String handlingType, LocalDate completionTime) {
